...
//		플래티넘 : 5, 2.7% 할인적용
		...
		if(grade == 1) {
			salesCost = 0.05;
			System.out.println("정가가 " + cost + "원인 일반 등급의 할인가는: " + (int)(cost * salesCost) + "원 입니다.");
		} else if(grade == 2){
			salesCost = 0.1;
			System.out.println("정가가 " + cost + "원인 브론즈 등급의 할인가는: " + (int)(cost * salesCost) + "원 입니다.");
		} else if(grade == 3){
			salesCost = 0.15;
			System.out.println("정가가 " + cost + "원인 실버 등급의 할인가는: " + (int)(cost * salesCost) + "원 입니다.");
		} else if(grade == 4){
			salesCost = 0.2;
			System.out.println("정가가 " + cost + "원인 골드 등급의 할인가는: " + (int)(cost * salesCost) + "원 입니다.");
		} else if(grade == 5){
			salesCost = 0.027;
			System.out.println("정가가 " + cost + "원인 플래티넘 등급의 할인가는: " + (int)(cost * salesCost) + "원 입니다.");
		} else {
